...
public class ConfigLoader extends Properties {
    ...
    private ConfigLoader() {
        ...
        try {
            propsStream = this.getClass().getClassLoader().getResourceAsStream(propsFileName);
            URL loc = this.getClass().getClassLoader().getResource(propsFileName);

/**** DEBUG_START ****/
            Logger.getLogger(ConfigLoader.class.getName()).log(Level.INFO, "Loaded property file (URL) = " + loc);
