 ...
 * Cause: Modification of some string descriptions and literals
 *
 */
...
public class RESTfulEPCISBusinessLogic extends AbstractBusinessLogic implements IRESTfulEPCISResource {
    ...
    public EPCISResource getRESTfulEPCIS(UriInfo context) {
        ...
        String   description = "Home Interface of the EPCIS Webadapter for the Shop Floor Data Collection Tag & Trace.";
    ...
    public EPCISResource getConfig(UriInfo context) {
        ...
        String   path        = CONFIG;
        String   description = "Configuration Interface of the EPCIS Webadapter for the Shop Floor Data Collection Tag & Trace.";
        EPCISResource resource    = setUpResource(context, name, description, path);
    ...
    public EPCISResource getResetRestfulEpcis(UriInfo context) {
        ...
        String   description = "Interface to reset the EPCIS Webadapter for the Shop Floor Data Collection Tag & Trace.";
        EPCISResource resource    = setUpResource(context, name, description, path);
    ...
    public EPCISResource doResetRestfulEpcis(UriInfo context) {
        ...
        String path        = CONFIG_RESET_RESTFULEPCIS;
        String description = "Interface to reset the EPCIS Webadapter for Shop Floor Data Collection Tag & Trace. The internal Database of the EPCIS Webadapter will be reseted not the Database of the EPCIS. Feed Subscriptions, the Event Finder and the internal Feeds are deleted.";
        EPCISResource resource = setUpResource(context, name, description, path);
    ...
    public EPCISResource getReloadFinder(UriInfo context) {
        ...
        String   description = "Interface to reload the EPCIS Webadapter for Shop Floor Data Collection Tag & Trace Event Finder.";
        EPCISResource resource    = setUpResource(context, name, description, path);
    ...
    public EPCISResource getAbout(UriInfo context) {
        String   name        = "About";
        String   path        = ABOUT;
        String   description = "About Interface of the EPCIS Webadapter for Shop Floor Data Collection Tag & Trace.";
        EPCISResource resource    = setUpResource(context, name, description, path);
    ...
    public EPCISResource getAuthors(UriInfo context) {
        ...
        String   description = "The Authors of the EPCIS Webadapter for Shop Floor Data Collection Tag & Trace.";
    ...
    public EPCISResource getAuthor(UriInfo context, String id) {
        String     name        = id;
        String     description = "Presenting an Author of the EPCIS Webadapter for Shop Floor Data Collection Tag & Trace.";
    ...
    public EPCISResource getVersion(UriInfo context) {
        ...
        String   description = "About Version Interface of the EPCIS Webadapter for Shop Floor Data Collection Tag & Trace.";
        EPCISResource resource    = setUpResource(context, name, description, path);
